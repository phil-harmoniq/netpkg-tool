...
wget_sdk() {
    ...
    wget https://download.microsoft.com/download/0/6/5/0656B047-5F2F-4281-A851-F30776F8616D/dotnet-dev-linux-x64.2.0.0-preview1-005977.tar.gz -O /tmp/dotnet-sdk.tar.gz
    STATUS=$?
...
wget_runtime() {
    ...
    wget https://download.microsoft.com/download/0/9/0/09060200-E749-4025-A51A-83391C611C86/dotnet-linux-x64.2.0.0-preview1-002111-00.tar.gz -O /tmp/dotnet-runtime.tar.gz
    STATUS=$?
    download_check STATUS
}
